...
--
-- Replaces the launch art ledger with full-roster coverage. Every row is re-encoded to WebP
-- at display resolution, so every storage_path and asset_sha256 changes; the previous rows
-- point at files this release no longer serves and are removed rather than disabled.
begin;
...
insert into public.character_art_assets (character_id, storage_path, source_url, source_publisher, license_url, asset_reuse_mode, credit_text, permission_evidence, asset_sha256, review_state, is_primary, retrieved_at, reviewed_at, disabled_at)
select c.id, '/art/umvc3-captain-america.webp', 'https://www.capcom-games.com/marvel-vs-capcom-fc/assets/images/title/title6/character/captain_america.png', 'Capcom / Marvel', 'https://www.capcom-games.com/en/terms/', 'publisher-promotional', 'Marvel vs. Capcom 2 art via Capcom; clearly labeled cross-version identity fallback for UMVC3', 'Official Capcom-hosted promotional art. Capcom fan-content guidance does not grant unchanged public display and excludes relevant third-party IP where applicable; included under accepted ADR-023 with the restriction and removal path recorded. Delivered as WebP re-encoded from the publisher source at display resolution; the source URL identifies the original asset. Capcom''s own UMVC3 high-resolution art post no longer publishes the Marvel half of the cast, so this version-mismatched MVC2 render stands in and is labeled as such.', 'sha256:ac477aed8fe6a2aaf27109ac7e06117d33bd61c97a7c6a54bcdfaa8259bde55f', 'approved', true, '2026-09-20', '2026-09-20', null
from public.characters c
join public.game_versions gv on gv.id = c.game_version_id
...
insert into public.character_art_assets (character_id, storage_path, source_url, source_publisher, license_url, asset_reuse_mode, credit_text, permission_evidence, asset_sha256, review_state, is_primary, retrieved_at, reviewed_at, disabled_at)
select c.id, '/art/umvc3-storm.webp', 'https://www.capcom-games.com/marvel-vs-capcom-fc/assets/images/title/title6/character/storm.png', 'Capcom / Marvel', 'https://www.capcom-games.com/en/terms/', 'publisher-promotional', 'Marvel vs. Capcom 2 art via Capcom; clearly labeled cross-version identity fallback for UMVC3', 'Official Capcom-hosted promotional art. Capcom fan-content guidance does not grant unchanged public display and excludes relevant third-party IP where applicable; included under accepted ADR-023 with the restriction and removal path recorded. Delivered as WebP re-encoded from the publisher source at display resolution; the source URL identifies the original asset. Capcom''s own UMVC3 high-resolution art post no longer publishes the Marvel half of the cast, so this version-mismatched MVC2 render stands in and is labeled as such.', 'sha256:23ea536eef73b1e30887bc5bf2847239ef0653a3161d5378b3c24a1348a241f8', 'approved', true, '2026-09-20', '2026-09-20', null
from public.characters c
join public.game_versions gv on gv.id = c.game_version_id
...
insert into public.character_art_assets (character_id, storage_path, source_url, source_publisher, license_url, asset_reuse_mode, credit_text, permission_evidence, asset_sha256, review_state, is_primary, retrieved_at, reviewed_at, disabled_at)
select c.id, '/art/umvc3-wolverine.webp', 'https://www.capcom-games.com/marvel-vs-capcom-fc/assets/images/title/title6/character/wolverine.png', 'Capcom / Marvel', 'https://www.capcom-games.com/en/terms/', 'publisher-promotional', 'Marvel vs. Capcom 2 art via Capcom; clearly labeled cross-version identity fallback for UMVC3', 'Official Capcom-hosted promotional art. Capcom fan-content guidance does not grant unchanged public display and excludes relevant third-party IP where applicable; included under accepted ADR-023 with the restriction and removal path recorded. Delivered as WebP re-encoded from the publisher source at display resolution; the source URL identifies the original asset. Capcom''s own UMVC3 high-resolution art post no longer publishes the Marvel half of the cast, so this version-mismatched MVC2 render stands in and is labeled as such.', 'sha256:522f7fcca99bf3e38a44d7b2ffe00a6d59a1f70456f7fa62777c84749ecdf580', 'approved', true, '2026-09-20', '2026-09-20', null
from public.characters c
join public.game_versions gv on gv.id = c.game_version_id
...
insert into public.character_art_assets (character_id, storage_path, source_url, source_publisher, license_url, asset_reuse_mode, credit_text, permission_evidence, asset_sha256, review_state, is_primary, retrieved_at, reviewed_at, disabled_at)
select c.id, '/art/umvc3-hulk.webp', 'https://www.capcom-games.com/marvel-vs-capcom-fc/assets/images/title/title6/character/hulk.png', 'Capcom / Marvel', 'https://www.capcom-games.com/en/terms/', 'publisher-promotional', 'Marvel vs. Capcom 2 art via Capcom; clearly labeled cross-version identity fallback for UMVC3', 'Official Capcom-hosted promotional art. Capcom fan-content guidance does not grant unchanged public display and excludes relevant third-party IP where applicable; included under accepted ADR-023 with the restriction and removal path recorded. Delivered as WebP re-encoded from the publisher source at display resolution; the source URL identifies the original asset. Capcom''s own UMVC3 high-resolution art post no longer publishes the Marvel half of the cast, so this version-mismatched MVC2 render stands in and is labeled as such.', 'sha256:69a56daa6106b39ca6cfcc631c3eab0b4db46e39a6e6e5cb872667296badf804', 'approved', true, '2026-09-20', '2026-09-20', null
from public.characters c
join public.game_versions gv on gv.id = c.game_version_id
...
insert into public.character_art_assets (character_id, storage_path, source_url, source_publisher, license_url, asset_reuse_mode, credit_text, permission_evidence, asset_sha256, review_state, is_primary, retrieved_at, reviewed_at, disabled_at)
select c.id, '/art/umvc3-sentinel.webp', 'https://www.capcom-games.com/marvel-vs-capcom-fc/assets/images/title/title6/character/sentinel.png', 'Capcom / Marvel', 'https://www.capcom-games.com/en/terms/', 'publisher-promotional', 'Marvel vs. Capcom 2 art via Capcom; clearly labeled cross-version identity fallback for UMVC3', 'Official Capcom-hosted promotional art. Capcom fan-content guidance does not grant unchanged public display and excludes relevant third-party IP where applicable; included under accepted ADR-023 with the restriction and removal path recorded. Delivered as WebP re-encoded from the publisher source at display resolution; the source URL identifies the original asset. Capcom''s own UMVC3 high-resolution art post no longer publishes the Marvel half of the cast, so this version-mismatched MVC2 render stands in and is labeled as such.', 'sha256:3e81653c9325e6835ff2f84dc2d09f94fa2e0d05eb2b091b14b59ecb78166165', 'approved', true, '2026-09-20', '2026-09-20', null
from public.characters c
join public.game_versions gv on gv.id = c.game_version_id
...
insert into public.character_art_assets (character_id, storage_path, source_url, source_publisher, license_url, asset_reuse_mode, credit_text, permission_evidence, asset_sha256, review_state, is_primary, retrieved_at, reviewed_at, disabled_at)
select c.id, '/art/umvc3-shuma-gorath.webp', 'https://www.capcom-games.com/marvel-vs-capcom-fc/assets/images/title/title6/character/shumagorath.png', 'Capcom / Marvel', 'https://www.capcom-games.com/en/terms/', 'publisher-promotional', 'Marvel vs. Capcom 2 art via Capcom; clearly labeled cross-version identity fallback for UMVC3', 'Official Capcom-hosted promotional art. Capcom fan-content guidance does not grant unchanged public display and excludes relevant third-party IP where applicable; included under accepted ADR-023 with the restriction and removal path recorded. Delivered as WebP re-encoded from the publisher source at display resolution; the source URL identifies the original asset. Capcom''s own UMVC3 high-resolution art post no longer publishes the Marvel half of the cast, so this version-mismatched MVC2 render stands in and is labeled as such.', 'sha256:1b7a3a1a8e2ce88565892b88dd1f6c63a370467a4f0f67d58ef0448eb5b11fb1', 'approved', true, '2026-09-20', '2026-09-20', null
from public.characters c
join public.game_versions gv on gv.id = c.game_version_id
...
do $$ declare approved integer; begin
  ...
  if approved <> 395 then
    raise exception 'Expected 395 approved primary art rows, found %', approved;
  end if;
end $$;
